...
<%
	...
	*/
	...
	list.add(c1);
	Custom c2 = new Custom("2", "李彦宏", "男",  "18933445566", "高级客户", "http://pengcan2006.gotoip3.com/photos/2.jpg", "现任全国政协委员、全国工商联副主席、百度公司董事长兼首席执行官、山西省工商联副主席。");
	list.add(c2);
	Custom c3 = new Custom("3", "马化腾", "男",  "18943345775", "高级客户", "http://pengcan2006.gotoip3.com/photos/3.jpg", "广东汕头人，腾讯主要创办人之一，现担任公司控股董事会主席兼首席执行官。");
	list.add(c3);
	//将数据放入结果集，并返回。 
